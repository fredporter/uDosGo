...
| **Variables + uCode** | [docs/specs/uDos-variables-ucode-v4.md](specs/uDos-variables-ucode-v4.md) | **Draft** — `$VAR$` / dotted paths for markdown surfaces; session via **uCode v4**; MCP/registry TBD; phases A→C |
