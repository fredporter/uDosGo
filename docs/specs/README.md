...
| uDos-Dev Vibe CLI plugin | [`vibe-plugin-udos-dev/docs/specs/`](../../../uDosConnect/uDosDev/vibe-plugin-udos-dev/docs/specs/) | **Locked** — `/task`, `/test`, `/commit`, `/release`, `/budget`, slice/PR addendum; install template → `~/.vibe/plugins/udos-dev` |
| TUI — ASCII animation toolkit | [`TUI_ASCII_ANIMATION_TOOLKIT_v1.0.0.md`](../../../uDosConnect/uDosDev/docs/specs/TUI_ASCII_ANIMATION_TOOLKIT_v1.0.0.md) | **Locked** — spinners, loaders, splash, formula patterns; **`@udos/tui-ascii`**; Shell palette `ascii:*`; Host **`GET /api/v1/meta/shell-palette`** |
